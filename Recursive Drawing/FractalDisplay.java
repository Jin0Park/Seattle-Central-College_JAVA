...
public class FractalDisplay extends JPanel implements MouseListener, ActionListener, ChangeListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().getClass() == JRadioButton.class) {
			...
			case SIERPINSKI_TRIANGLE:
				Point[] p = {new Point(0, FractalDisplay.HEIGHT - 125), 
							 new Point(FractalDisplay.WIDTH / 2, 0), 
							 new Point(FractalDisplay.WIDTH, FractalDisplay.HEIGHT - 125)};
				shape = new SierpinskiTriangle(1, Color.GREEN, p);
				break;
			case H_SHAPE:
				Point[] p1 = {new Point(0, 0),
							  new Point(0, FractalDisplay.HEIGHT - 125),
							  new Point(FractalDisplay.WIDTH, FractalDisplay.HEIGHT - 125),
							  new Point(FractalDisplay.WIDTH, 0)};
				shape = new HShape(1, Color.ORANGE, p1);
				break;
			case MY_SHAPE:
				Point[] m = {new Point(FractalDisplay.WIDTH / 2, FractalDisplay.HEIGHT - 125),
							 new Point(FractalDisplay.WIDTH / 2, FractalDisplay.HEIGHT - 350)};
				shape = new MyShape(1, Color.DARK_GRAY, m);
				break;
			}
	...
	/**
	 * Displays a message box giving the total number shapes in the current `
	 */
